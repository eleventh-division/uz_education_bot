...
bot.onText(/\/start/, (msg) =>  {
  ...
  bot.sendMessage(chatId, 'Здравствуйте, я могу Вас проинформировать о дистанционном образовании в Узбекистане, \
и за рубежом.\n\
Но пока, что бот в разработке, можете обратиться к нам по контактам:\n\
